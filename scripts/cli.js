...
const contractABI = require("../artifacts/contracts/Apolloserver.sol/Apolloserver.json").abi;

program
    .name("apolloserver-cli")
    .description("CLI tool for Apolloserver smart contract")
    .version("1.0.0");
